...
const MdvipPage: React.FC<MdvipPageProps> = ({ onNavigate }) => {
    ...
    const PIC2_URL = "https://raw.githubusercontent.com/nmlippey/palmandneedlemed-assets/main/Pic_2.jpg";
                        ...
                        <div className="space-y-32">
                            ...
                            <div className="grid lg:grid-cols-12 gap-16 items-center">
                                <div className="lg:col-span-7 space-y-8">
                                    <h2 className="text-3xl font-bold text-[#9ba37a] serif">Annual exams that go beyond the basics</h2>
                            ...
                            <div className="space-y-12">
                                <div className="text-center max-w-3xl mx-auto">
                                    <h2 className="text-3xl font-bold text-[#9ba37a] serif mb-6">A true partnership in care</h2>
                                ...
                                <div className="grid md:grid-cols-3 gap-8">
                                    {[
                                        ...
                                        <div key={i} className="border-l-2 border-[#d18dbd] pl-6 py-6 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
                                            <h3 className="text-lg font-bold text-[#9ba37a] serif mb-3">{item.title}</h3>
                            ...
                            <div className="grid lg:grid-cols-12 gap-16 items-center">
                                ...
                                <div className="lg:col-span-8 order-1 lg:order-2 space-y-10">
                                    <h2 className="text-4xl font-bold text-[#9ba37a] serif">Care that doesn’t keep you waiting</h2>
                            ...
                            <div className="space-y-16 py-16 border-t border-slate-100">
                                <div className="text-center max-w-3xl mx-auto space-y-6">
                                    <h2 className="text-4xl font-bold text-[#9ba37a] serif">Support for specialized care</h2>
                                ...
                                <div className="grid md:grid-cols-3 gap-8">
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">Referrals & Appointments</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Assisting with referrals and appointment requests at nationally recognized medical institutions.
                                        </p>
                                    </div>
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">Record Sharing</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Helping you share medical records and test results with specialists at partner medical centers.
                                        </p>
                                    </div>
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">Logistics Support</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                            ...
                            <div className="space-y-12 pt-16 border-t border-slate-100">
                                <div className="grid md:grid-cols-2 gap-12">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">How is the fee structure set?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">How do labs, referrals, and imaging work?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Referrals, labs, and imaging orders can be placed by me that can then be billed through your insurance.
                                        </p>
                                    </div>
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#9ba37a] serif">Do you take Flexible Spending Account (FSA)/Health Savings Account (HSA) cards?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
