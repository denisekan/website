                    ...
                    <div className="max-w-6xl mx-auto px-4 relative z-10">
                        <div className="space-y-32">
                            ...
                            <div className="bg-slate-50/95 p-16 rounded-lg border border-slate-100 backdrop-blur-md shadow-sm text-center relative overflow-hidden">
                                ...
                                <h2 className="text-3xl font-bold text-[#8ca38a] serif mb-8">Care that puts you first</h2>
                                <div className="space-y-6 max-w-3xl mx-auto">
                                    <p className="text-xl font-medium text-[#7abf7d]">Whether you’re focused on maximizing your healthspan or managing a chronic condition, an MDVIP-affiliated doctor can deliver care aligned with your personal health goals.</p>
                            ...
                            <div className="grid lg:grid-cols-12 gap-16 items-center">
                                <div className="lg:col-span-7 space-y-8">
                                    <h2 className="text-3xl font-bold text-[#8ca38a] serif">Annual exams that go beyond the basics</h2>
                            ...
                            <div className="space-y-12">
                                <div className="text-center max-w-3xl mx-auto">
                                    <h2 className="text-3xl font-bold text-[#8ca38a] serif mb-6">A true partnership in care</h2>
                                ...
                                <div className="grid md:grid-cols-3 gap-8">
                                    {[
                                        ...
                                        <div key={i} className="border-l-2 border-[#d4a5d9] pl-6 py-6 bg-white rounded shadow-sm hover:shadow-md transition-shadow">
                                            <h3 className="text-lg font-bold text-[#8ca38a] serif mb-3">{item.title}</h3>
                            ...
                            <div className="grid lg:grid-cols-12 gap-16 items-center">
                                <div className="lg:col-span-4 flex justify-center lg:justify-start order-2 lg:order-1">
                                    <div className="relative group max-w-[400px]">
                                        <div className="absolute -inset-2 bg-[#7abf7d]/10 rounded rotate-[-4deg] group-hover:rotate-0 transition-transform blur-lg opacity-40"></div>
                                ...
                                <div className="lg:col-span-8 order-1 lg:order-2 space-y-10">
                                    <h2 className="text-4xl font-bold text-[#8ca38a] serif">Care that doesn’t keep you waiting</h2>
                                    ...
                                    <ul className="space-y-6">
                                        {[
                                            ...
                                            <li key={i} className="flex items-start space-x-4 text-slate-700">
                                                <span className="w-2 h-2 rounded-full bg-[#d4a5d9] mt-2.5 shrink-0"></span>
                            ...
                            <div className="space-y-16 py-16 border-t border-slate-100">
                                <div className="text-center max-w-3xl mx-auto space-y-6">
                                    <h2 className="text-4xl font-bold text-[#8ca38a] serif">Support for specialized care</h2>
                                ...
                                <div className="grid md:grid-cols-3 gap-8">
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">Referrals & Appointments</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Assisting with referrals and appointment requests at nationally recognized medical institutions.
                                        </p>
                                    </div>
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">Record Sharing</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Helping you share medical records and test results with specialists at partner medical centers.
                                        </p>
                                    </div>
                                    <div className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-shadow space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">Logistics Support</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                            ...
                            <div className="py-12 flex justify-center">
                                <div className="relative group max-w-4xl w-full">
                                    <div className="absolute -inset-4 bg-[#7abf7d] opacity-10 rounded-lg rotate-1 blur-lg"></div>
                                    <img 
                                        src={ADD1_URL} 
                            ...
                            <div className="space-y-12 pt-16 border-t border-slate-100">
                                <div className="grid md:grid-cols-2 gap-12">
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">Do I still need insurance?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">How is the fee structure set?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">How do labs, referrals, and imaging work?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                                            Referrals, labs, and imaging orders can be placed by me that can then be billed through your insurance.
                                        </p>
                                    </div>
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-bold text-[#8ca38a] serif">Do you take Flexible Spending Account (FSA)/Health Savings Account (HSA) cards?</h3>
                                        <p className="text-slate-600 text-sm leading-relaxed">
                            ...
                            <div className="space-y-12 pt-16 border-t border-slate-100">
                                <div className="text-center max-w-3xl mx-auto space-y-6">
                                    <h2 className="text-4xl font-bold text-[#8ca38a] serif">Annual Membership Fee</h2>
                                    ...
                                    <div className="bg-slate-50 p-8 rounded-lg">
                                        <div className="grid grid-cols-3 gap-4 text-center">
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-2xl font-bold text-[#8ca38a] serif">$862.50</p>
                                            </div>
                                            <div className="space-y-2 border-x border-slate-200">
                                                ...
                                                <p className="text-2xl font-bold text-[#8ca38a] serif">$1,725.00</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-xs uppercase tracking-widest font-bold text-slate-500">Annual</p>
                                                <p className="text-2xl font-bold text-[#8ca38a] serif">$3,450.00</p>
                                            </div>
                                        </div>
                                    </div>
                                    <p className="text-slate-600 font-medium">
                                        To learn more about the Membership or the Annual Wellness program, call <a href="tel:650-643-3702" className="text-[#d4a5d9] hover:underline">650-643-3702</a>
                                    </p>
                                </div>
                            </div>
