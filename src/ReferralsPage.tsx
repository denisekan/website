...
Urgency: ${formData.urgency}
            `;
            window.location.href = `mailto:care@denisekanmd.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    ...
    const inputClasses = "w-full bg-slate-50 p-4 rounded-sm text-sm border border-slate-200 outline-none focus:ring-2 focus:ring-[#8db56d] transition-all";
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-2xl font-bold text-[#9ba37a] serif">Patient Information</h2>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-2xl font-bold text-[#9ba37a] serif">Referring Clinician Information</h2>
                                <div className="flex-grow h-px bg-slate-100"></div>
                            </div>
                        ...
                        <div className="pt-8">
                            <button type="submit" className="w-full bg-[#d18dbd] text-white py-6 font-bold uppercase tracking-[0.4em] text-xs hover:bg-white hover:text-[#9ba37a] transition-all shadow-xl hover:-translate-y-1 rounded-sm">
                                Submit Referral
                            </button>
                        </div>
                    </form>
