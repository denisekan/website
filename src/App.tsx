                    ...
                    <div className="lg:col-span-5 space-y-8 animate-fade-in relative z-10">
                        <div className="space-y-4">
                            <div className="text-left">
                                ...
                                <p className="text-xl md:text-2xl tracking-[0.4em] uppercase text-[#eac4e1] font-bold mt-2">Primary Care Physician</p>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
                            <a href="#about" onClick={(e) => { e.preventDefault(); navigateTo('about'); }} className="bg-[#d18dbd] text-white px-10 py-5 rounded-sm font-bold text-xs uppercase tracking-[0.2em] hover:bg-white hover:text-[#d18dbd] transition-all shadow-xl hover:-translate-y-1 text-center">About Dr. Kan</a>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="space-y-8 order-1 lg:order-2">
                        <div className="flex items-center space-x-4">
                            <span className="text-[#d18dbd] uppercase tracking-[0.4em] font-bold text-xs">Meet Your Doctor</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#9ba37a] serif leading-tight">A Higher Standard of Healthcare</h2>
                        ...
                        <div className="pt-6">
                             <button onClick={() => navigateTo('about')} className="text-[#d18dbd] font-bold text-xs uppercase tracking-[0.2em] hover:text-[#9ba37a] flex items-center group">
