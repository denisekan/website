...
const App = () => {
    ...
    const LandingPage = () => (
        <>
            <header id="home" className="relative pt-80 pb-24 bg-[#8ca38a] overflow-hidden">
                    ...
                    <div className="lg:col-span-5 space-y-8 animate-fade-in relative z-10">
                        <div className="space-y-4">
                            <div className="text-left">
                                <h1 className="text-4xl md:text-6xl font-bold text-white serif leading-tight whitespace-nowrap">Denise Kan, MD</h1>
                                <p className="text-xl md:text-2xl tracking-[0.4em] uppercase text-[#d4a5d9] font-bold mt-2">Primary Care Physician</p>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-bold text-white serif leading-tight italic">
                                A personalized <br className="hidden md:block" />
                                healthcare experience.
                            </h2>
                        </div>
                        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
                            <a href="#about" onClick={(e) => { e.preventDefault(); navigateTo('about'); }} className="bg-[#d4a5d9] text-white px-10 py-5 rounded-sm font-bold text-xs uppercase tracking-[0.2em] hover:bg-white hover:text-[#d4a5d9] transition-all shadow-xl hover:-translate-y-1 text-center">About Dr. Kan</a>
                        </div>
                    </div>
                    <div className="lg:col-span-7 relative animate-fade-in lg:translate-x-12">
                        <div className="absolute -inset-8 bg-[#7abf7d] opacity-10 -rotate-2 blur-3xl"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-24 items-center">
                    <div className="flex justify-center order-2 lg:order-1">
                        <div className="max-w-xs w-full relative group">
                            <div className="absolute -inset-4 bg-[#7abf7d] opacity-10 rounded-lg rotate-3 group-hover:rotate-0 transition-transform blur-lg"></div>
                            ...
                            <div className="absolute -bottom-8 -right-8 bg-[#d4a5d9] text-white px-8 py-5 rounded shadow-2xl z-20 border-2 border-white/10">
                    ...
                    <div className="space-y-8 order-1 lg:order-2">
                        <div className="flex items-center space-x-4">
                            <span className="text-[#d4a5d9] uppercase tracking-[0.4em] font-bold text-xs">Meet Your Doctor</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#8ca38a] serif leading-tight">A Higher Standard of Healthcare</h2>
                        ...
                        <div className="pt-6">
                             <button onClick={() => navigateTo('about')} className="text-[#d4a5d9] font-bold text-xs uppercase tracking-[0.2em] hover:text-[#8ca38a] flex items-center group">
            ...
            <section id="contact" className="py-20 lg:py-32 bg-[#8ca38a] text-white relative z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
                    ...
                    <div className="bg-white p-6 md:p-8 lg:p-12 rounded shadow-2xl relative text-slate-800 flex flex-col items-center justify-center min-h-[300px]">
                        <div className="relative lg:absolute lg:-top-44 lg:-left-12 w-24 h-24 md:w-32 md:h-32 lg:w-48 lg:h-48 bg-white rounded flex items-center justify-center shadow-2xl border-4 border-[#d4a5d9] transform hover:rotate-12 transition-transform overflow-hidden p-0 z-20 mb-8 lg:mb-0">
                        ...
                        <div className="text-center space-y-8 w-full">
                            ...
                            <a 
                                ...
                                className="flex items-center justify-center w-full bg-[#d4a5d9] text-white py-6 font-bold uppercase tracking-[0.4em] text-xs hover:bg-white hover:text-[#8ca38a] transition-all shadow-xl hover:-translate-y-1 text-center pl-[0.4em] md:pl-0 md:block"
                            >
